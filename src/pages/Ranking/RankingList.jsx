...
const RankingList = () => {
  ...
  const requestAxios = async (page) => {
    try {
      const apiUrl =
        page === undefined
          ? `api/songs?sort=query_count,desc`
          : `api/songs?sort=query_count,desc&page=${page}`;
  ...
  return (
    <div className="flex flex-col py-5 px-3 items-center">
      <h1 className="text-4xl font-bold mb-5">BẢNG XẾP HẠNG NHẠC MỚI</h1>
